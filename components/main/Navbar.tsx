      ...
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
        ...
        <div className="navbar-start lg:hidden flex">
          <div className="dropdown ">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-40 p-2 shadow glassEffect"
            >
              <li>
        ...
        <a
          href="#about-me"
          className="h-auto w-auto hidden lg:flex flex-row items-center"
        >
          <Image
            src="/NavLogo.png"
            alt="logo"
